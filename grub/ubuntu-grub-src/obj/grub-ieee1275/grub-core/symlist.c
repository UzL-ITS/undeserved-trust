...
#include <../../../include/grub/ieee1275/ieee1275.h>
  ...
  static struct symtab tab[] =
    {
      ...
      {"grub_ieee1275_canonicalise_devname", grub_ieee1275_canonicalise_devname, 1},
      {"grub_ieee1275_child", grub_ieee1275_child, 1},
      {"grub_ieee1275_children_first", grub_ieee1275_children_first, 1},
      {"grub_ieee1275_children_peer", grub_ieee1275_children_peer, 1},
      {"grub_ieee1275_chosen", (void *) &grub_ieee1275_chosen, 0},
      {"grub_ieee1275_claim", grub_ieee1275_claim, 1},
      {"grub_ieee1275_close", grub_ieee1275_close, 1},
      {"grub_ieee1275_decode_unit4", grub_ieee1275_decode_unit4, 1},
      {"grub_ieee1275_devalias_free", grub_ieee1275_devalias_free, 1},
      {"grub_ieee1275_devalias_init_iterator", grub_ieee1275_devalias_init_iterator, 1},
      {"grub_ieee1275_devalias_next", grub_ieee1275_devalias_next, 1},
      {"grub_ieee1275_devices_iterate", grub_ieee1275_devices_iterate, 1},
      {"grub_ieee1275_encode_devname", grub_ieee1275_encode_devname, 1},
      {"grub_ieee1275_encode_uint4", grub_ieee1275_encode_uint4, 1},
      {"grub_ieee1275_enter", grub_ieee1275_enter, 1},
      {"grub_ieee1275_entry_fn", (void *) &grub_ieee1275_entry_fn, 0},
      {"grub_ieee1275_exit", grub_ieee1275_exit, 1},
      {"grub_ieee1275_finddevice", grub_ieee1275_finddevice, 1},
      {"grub_ieee1275_get_aliasdevname", grub_ieee1275_get_aliasdevname, 1},
      {"grub_ieee1275_get_block_size", grub_ieee1275_get_block_size, 1},
      {"grub_ieee1275_get_boot_dev", grub_ieee1275_get_boot_dev, 1},
      {"grub_ieee1275_get_device_type", grub_ieee1275_get_device_type, 1},
      {"grub_ieee1275_get_devname", grub_ieee1275_get_devname, 1},
      {"grub_ieee1275_get_filename", grub_ieee1275_get_filename, 1},
      {"grub_ieee1275_get_integer_property", grub_ieee1275_get_integer_property, 1},
      {"grub_ieee1275_get_property", grub_ieee1275_get_property, 1},
      {"grub_ieee1275_get_property_length", grub_ieee1275_get_property_length, 1},
      {"grub_ieee1275_init", grub_ieee1275_init, 1},
      {"grub_ieee1275_instance_to_package", grub_ieee1275_instance_to_package, 1},
      {"grub_ieee1275_instance_to_path", grub_ieee1275_instance_to_path, 1},
      {"grub_ieee1275_interpret", grub_ieee1275_interpret, 1},
      {"grub_ieee1275_map", grub_ieee1275_map, 1},
      {"grub_ieee1275_milliseconds", grub_ieee1275_milliseconds, 1},
      {"grub_ieee1275_mmu", (void *) &grub_ieee1275_mmu, 0},
      {"grub_ieee1275_net_config", (void *) &grub_ieee1275_net_config, 0},
      {"grub_ieee1275_next_property", grub_ieee1275_next_property, 1},
      {"grub_ieee1275_no_data_command", grub_ieee1275_no_data_command, 1},
      {"grub_ieee1275_open", grub_ieee1275_open, 1},
      {"grub_ieee1275_package_to_path", grub_ieee1275_package_to_path, 1},
      {"grub_ieee1275_parent", grub_ieee1275_parent, 1},
      {"grub_ieee1275_peer", grub_ieee1275_peer, 1},
      {"grub_ieee1275_read", grub_ieee1275_read, 1},
      {"grub_ieee1275_release", grub_ieee1275_release, 1},
      {"grub_ieee1275_seek", grub_ieee1275_seek, 1},
      {"grub_ieee1275_set_address", grub_ieee1275_set_address, 1},
      {"grub_ieee1275_set_color", grub_ieee1275_set_color, 1},
      {"grub_ieee1275_set_flag", grub_ieee1275_set_flag, 1},
      {"grub_ieee1275_set_property", grub_ieee1275_set_property, 1},
      {"grub_ieee1275_test_flag", grub_ieee1275_test_flag, 1},
      {"grub_ieee1275_write", grub_ieee1275_write, 1},

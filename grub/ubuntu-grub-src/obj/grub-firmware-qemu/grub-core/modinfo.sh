...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_QEMU=1 -DGRUB_MACHINE=I386_QEMU -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/8/include -I$(top_srcdir)/include -I$(top_builddir)/include'
